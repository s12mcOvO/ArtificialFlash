...
{
    int32_t HomeViewModel::DatasetCount()
    {
    ...
    {
        if (m_datasetCount != value)
        {
            m_datasetCount = value;
            RaisePropertyChanged(L"DatasetCount");
        }
    }

    int32_t HomeViewModel::ModelCount()
    {
        return m_modelCount;
    }
    ...
    {
        if (m_modelCount != value)
        {
            m_modelCount = value;
            RaisePropertyChanged(L"ModelCount");
        }
    }

    bool HomeViewModel::IsTrainingActive()
    {
        return m_isTrainingActive;
    }

    void HomeViewModel::IsTrainingActive(bool value)
    {
        if (m_isTrainingActive != value)
        {
            m_isTrainingActive = value;
            RaisePropertyChanged(L"IsTrainingActive");
        }
    }

    winrt::hstring HomeViewModel::BackendStatus()
    {
    ...
    void HomeViewModel::BackendStatus(winrt::hstring const& value)
    {
        if (m_backendStatus != value)
        {
            ...
            RaisePropertyChanged(L"BackendStatus");
        }
    }
    ...
    void HomeViewModel::Refresh()
    {
        ...
        {
            if (session.status == Models::TrainingStatus::Training ||
        ...
        BackendStatus(backend.IsHealthy() ? L"Running" : L"Offline");
    }
